...
Write-Host "⬆️  Installing mqtt-presence (editable) from local source..."
...
try {
    ...
    Write-Host "ℹ️  Service not found or not running."
}

# Dienst (neu) registrieren
Write-Host "🛠️  Registering service '$ServiceName'..."
